...
/* for coverity(CID:441503, 4416083), fix IS_SPIFLASH and IS_NANDFLASH redefine warning */
...
{
	return ((regRead32(0xbfb00064) >> 16) & 0xFFFF);
}
...
#define isEN7561HU	(isEN7528 && (GET_PACKAGE_ID == 0x4))
