#ifndef _AIR_P2L_XSGMII_CONFIG_
#define _AIR_P2L_XSGMII_CONFIG_
...
#define VER "AN7581.PCIE2L.2.2.5R"
...
//#define TEST
//#ifdef TEST
//static RGDATA_t aux = {(0b11111111<<24)|(0b11111110<<16)|(0b10101110<<8)|(0b01001111<<0)};
//#else
static RGDATA_t aux = {(0b11111000<<24)|(0b10111110<<16)|(0b10101110<<8)|(0b01001101<<0)};
//#endif


//PMA
#define RX_PRCal_EN aux.bit.b9
#define E1_SWA_INJOSC_KB_EN RX_PRCal_EN
//PCS
...
//MISC
//const u8 XSGMII_USXGMII_INT_EN  =0;
//#define XSGMII_USXGMII_INT_EN (aux.bit.b1 = 0)
...
#define RX_OSCAL_BEFORE_CDR_RST_EN aux.bit.b30
#define PCIE1_PLL_STAND_ALONE_EN aux.bit.b31

//---------------------------flag---------------------------
static RGDATA_t xsgmii_flag = {0};
//PMA
//PCS
#define linkup_sta0 xsgmii_flag.bit.b8
#define linkdn_sta0 xsgmii_flag.bit.b9
#define linkup_sta1 xsgmii_flag.bit.b10
#define linkdn_sta1 xsgmii_flag.bit.b11
...
static struct timer_list TMR[2];
static u32 TMR0_CNT = 0;
static u32 TMR1_CNT = 0;
static u8 TMR_div = 10;
#define TMR_DIV TMR_div
//---------------------------ext module---------------------------
#include "air_pcie2l_xsgmii_ini.h"
//#include "air_pcie2L_dbg_function.h"
