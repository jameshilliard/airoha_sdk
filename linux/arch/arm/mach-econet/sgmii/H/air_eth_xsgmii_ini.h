#ifndef AIR_ETH_XSGMII_INI
#define AIR_ETH_XSGMII_INI
...
static inline void xsgmii_ini(volatile xsgmii_base * _pxSGMII){
	...
	//RG_W_PL(_pxSGMII->pma_base,PMA_BASE_OFFSET,(RgAddr) 0xb530 ,0x2dda0320 );
	...
	RG_W_PL(_pxSGMII->pma_base,PMA_BASE_OFFSET,(RgAddr) 0xb380 ,0x1c002000 );
	RG_W_PL(_pxSGMII->pcs1_base,USXGMII_PCS1_BASE_OFFSET,(RgAddr) 0xbf8 ,0x6330001 );
	RG_W_PL(_pxSGMII->pcs1_base,USXGMII_PCS1_BASE_OFFSET,(RgAddr) 0x930 ,0xc );
	...
	RG_W_PL(_pxSGMII->pcs1_base,USXGMII_PCS1_BASE_OFFSET,(RgAddr) 0xbd8 ,0x1010101 );
	...
	RG_W_PL(_pxSGMII->an_base,SGMII_AN_BASE_OFFSET,(RgAddr)_sgmii_reg_an_force_cl37,0x0 );
	RG_W_PL(_pxSGMII->pcs2_base,USXGMII_PCS2_BASE_OFFSET,(RgAddr) _rg_hsgmii_pcs_ctrol_3,0);
	}
...
#ifndef AIR_ETH_DBG_FUNCTION
#define AIR_ETH_DBG_FUNCTION
