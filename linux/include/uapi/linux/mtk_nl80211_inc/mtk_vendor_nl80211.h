...
/* don't change the order or add anything between, this is ABI! */
	...
	/* Airoha add new commands below */
	MTK_NL80211_VENDOR_SUBCMD_GET_TRAFFIC_STATS,
 ...
 * @MTK_NL80211_VENDOR_ATTR_TEST锛歟nable nl80211 test
 */
 ...
 * @MTK_NL80211_VENDOR_ATTR_TEST锛歳eceive nl80211 test event
 */
...
/**
 * enum mtk_nl80211_vendor_attr_get_traffic_stats - Specifies the vendor attribute values
 * to get static info added by Airoha
 */
enum mtk_nl80211_vendor_attr_get_traffic_stats {
	/* don't change the order or add anything between, this is ABI! */
	MTK_NL80211_VENDOR_ATTR_GET_TRAFFIC_STATS_INVALID = 0,

	MTK_NL80211_VENDOR_ATTR_GET_TRAFFIC_STATS,

	__MTK_NL80211_VENDOR_ATTR_GET_TRAFFIC_STATS_LAST,
	MTK_NL80211_VENDOR_ATTR_GET_TRAFFIC_STATS_MAX =
	__MTK_NL80211_VENDOR_ATTR_GET_TRAFFIC_STATS_LAST - 1
};
 ...
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_EMLMR: u8, EMLMR of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_EMLSR: u8, EMLSR of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_STR: u8, STR of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_NSTR: u8, NSTR of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LAST_CONNECT_TIME: u64, Last connect time of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_BYTES_SENT:u32, Bytes sent by the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_BYTES_RECEIVED: u32, Bytes received by the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_PACKETS_SENT:u32, Packets sent by the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_PACKETS_RECEIVED: u32, Packets received by the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_ERRORS_SENT: u32, Errors sent by the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_ERRORS_RECEIVED: u32, Errors received by the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_RETRIES: u32, Retries of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP: flag, Link map of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP_DIRECTION: u8, Link map direction of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP_TID: u8, Link map tid of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP_BSSID: u8[6], Link map bssid of the connected STA MLD.
 * @MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP_LINK_ID: u8, Link map link id of the connected STA MLD.
...
/* don't change the order or add anything between, this is ABI! */
	...
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_BYTES_SENT,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_BYTES_RECEIVED,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_PACKETS_SENT,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_PACKETS_RECEIVED,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_ERRORS_SENT,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_ERRORS_RECEIVED,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_RETRIES,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP_DIRECTION,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP_TID,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP_BSSID,
	MTK_NL80211_VENDOR_ATTR_CONNECTED_STA_MLD_LINK_MAP_LINK_ID,
