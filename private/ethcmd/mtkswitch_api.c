...
int macMT7530GetPortCnt(u8 port, mt7530_switch_api_cnt *portcnt)
{
...
**_______________________________________________________________
*/
int macMT7530SetPortMatrix(int port_group[6], int type)
{
    int i = 0;
    mt7530_switch_api_matrix_t matrix_p;
    for(i = 0; i < 6; i++)
        matrix_p.group[i] = port_group[i];
    matrix_p.type = type;
	return macMT7530gswAPIEntrance(CMD_SET_PORT_MATRIX, 0, (void *)&matrix_p);
}

int macMT7530SetLan2Lanswitch()
{
	return macMT7530gswAPIEntrance(CMD_SET_LAN2LAN_SWITCH,0, NULL);
}
/*___________________________________________________________________
...
/*___________________________________________________________________
**      function name: macMT7530SetVipPkt
**      descriptions:
**         set switch vip packet
**	
**      parameters:
**
**      global:
...
int macMT7530SetVipPkt(mt7530_switch_vip_info *vip_info)
{
	return macMT7530gswAPIEntrance(CMD_SET_VIP_PKT, 0, (void *)vip_info);
}

#ifdef TCSUPPORT_MT7530_SWITCH_API
int macMT7530GetBRTable(u8 port, mt7530_switch_brtable *out_pBrtable)	
{
    return macMT7530gswAPIEntrance(CMD_GET_BR_TABLE, port, (void *)(out_pBrtable));
}

int macMT7530GetPortByMac(mt7530_switch_macinfo *inptr_PortMac)
{
    
    return macMT7530gswAPIEntrance(CMD_GET_PORT_BY_MAC, 0, (void *)(inptr_PortMac));
}

int macMT7530SetMulArlIpTblAdd(mt7530_switch_arl_mul_iptbladd_t *mul_iptbl_info)
{
	return macMT7530gswAPIEntrance(CMD_SET_MUL_IPTBL_ADD, 0, (void *)mul_iptbl_info);
}

int macMT7530CleanSpecifiedArlDipTblByDip(u32 is_extend_gsw, u32 dip){
	mt7530_switch_api_paramext2 paramext;

	paramext.p1 = (u32)is_extend_gsw;
	paramext.p2 = (u32)dip;
    
	return macMT7530gswAPIEntrance(CMD_SET_ARL_DIPTBL_CLEAN_BY_DIP, 0, (void *)(&paramext));   
}
...
int macMT7530CleanSpecifiedArlSipTblByDipSip(u32 is_extend_gsw, u32 dip, u32 sip){
	...
	return macMT7530gswAPIEntrance(CMD_SET_ARL_SIPTBL_CLEAN_BY_DIPSIP, 0, (void *)(&paramext));
}
...
int macMT7530CleanMultipleArlSipTblBySip(u32 is_extend_gsw, u32 sip){
	...
	return macMT7530gswAPIEntrance(CMD_SET_ARL_SIPTBL_CLEAN_BY_SIP, 0, (void *)(&paramext));
}
...
int macMT7530CleanMultipleArlSipTblByDip(u32 is_extend_gsw, u32 dip){
	...
	return macMT7530gswAPIEntrance(CMD_SET_ARL_SIPTBL_CLEAN_BY_DIP, 0, (void *)(&paramext));
}
#endif
/*___________________________________________________________________
...
int macMT7530APIctagWhiteListMode(u8 mode)
{
    return macMT7530gswAPIEntrance(CMD_WHITE_LIST_MODE, 0, (void *)mode);
}
int macMT7530APIctagWhiteListPerPortMode(u8 port, u8 mode)
{
    return macMT7530gswAPIEntrance(CMD_WHITE_LIST_PER_PORT_MODE, port, (void *)mode);
}
int macMT7530APIctagWhiteListAdd(u8 port,u16 vid)
{
    return macMT7530gswAPIEntrance(CMD_WHITE_LIST_ADD, port, (void *)vid);
}
int macMT7530APIctagWhiteListDel(u8 port,u16 vid)
{
    return macMT7530gswAPIEntrance(CMD_WHITE_LIST_DEL, port, (void *)vid);
}
