...
ECONET SOFTWARE.
***************************************************************/
#ifndef _XSI_REG_7583_H_
#define _XSI_REG_7583_H_
...
#define XSI_AE_BASE		0xbfa08000
#define	XSI_PCIE0_BASE	0xbfa04000
#define	XSI_PCIE1_BASE	0xbfa04000
#define	XSI_USB_BASE	0xbfa05000
#define	XSI_ETH_BASE	0xbfa09000
...
#define XSI_MAX_IDX     5

#define PON_SEL_GDMA 		FE_GDM_SEL_GDMA2
#define ETH_SEL_GDMA		FE_GDM_SEL_GDMA3
#define PCIE0_SEL_GDMA		FE_GDM_SEL_GDMA4
#define PCIE1_SEL_GDMA		FE_GDM_SEL_GDMA4
#define USB_SEL_GDMA		FE_GDM_SEL_GDMA4

#define PCIE0_RETIRE_CHN  0
#define PCIE1_RETIRE_CHN  0
#define USB_RETIRE_CHN    1
#define ETH_RETIRE_CHN    32

#define HSGMII_LAN_ETH_SRCPORT		0x16
#define HSGMII_LAN_PCIE0_SRCPORT	0x18
#define HSGMII_LAN_PCIE1_SRCPORT	0x18
#define HSGMII_LAN_USB_SRCPORT		0x19

extern uint HSGMII_BASE_REG[5];

//need set in 7581
#if 0 
#define PON_VALID 		(((int)get_serdes_sel(ECNT_EVENT_PON_HSGMII)) == 1) ? 1 : 0
#define USB_VALID 		(((int)get_serdes_sel(ECNT_EVENT_USB3_HSGMII)) == 1) ? 1 : 0
#define PCIE0_VALID 	(((int)get_serdes_sel(ECNT_EVENT_PCIE0_HSGMII)) == 1) ? 1 : 0
#define PCIE1_VALID 	(((int)get_serdes_sel(ECNT_EVENT_PCIE1_HSGMII)) == 1) ? 1 : 0
#endif


//serdes work as hsgmii,uxsgmii,or sgmii.
#define PON_XSGMII_VALID 		(((get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_PON) ==ECNT_EVENT_SERDES_PON_XFI) || (get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_PON) ==ECNT_EVENT_SERDES_PON_USXGMII) || (get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_PON) ==ECNT_EVENT_SERDES_PON_HSGMII))?1:0)
#define USB_XSGMII_VALID 		(((get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_USB1) ==ECNT_EVENT_SERDES_USB1_HSGMII))?1:0)
#define PCIE0_XSGMII_VALID 		(((get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_WIFI1) ==ECNT_EVENT_SERDES_WIFI1_HSGMII) || (get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_WIFI1) ==ECNT_EVENT_SERDES_WIFI1_USXGMII)  || (get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_WIFI1) ==ECNT_EVENT_SERDES_WIFI1_XFI))?1:0)
#define PCIE1_XSGMII_VALID 		(((get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_WIFI2) ==ECNT_EVENT_SERDES_WIFI2_HSGMII) || (get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_WIFI2) ==ECNT_EVENT_SERDES_WIFI2_USXGMII) || (get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_WIFI2) ==ECNT_EVENT_SERDES_WIFI2_XFI))?1:0)
#define ETH_XSGMII_VALID 		(((get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_ETHER) ==ECNT_EVENT_SERDES_ETHER_XFI) || (get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_ETHER) ==ECNT_EVENT_SERDES_ETHER_USXGMII) || (get_serdes_interface_sel(ECNT_EVENT_SERDES_SEL_ETHER) ==ECNT_EVENT_SERDES_ETHER_HSGMII))?1:0)


//serdes may work as lan or wan,choose serdes work as lan and in hsgmii,usxgmii or sgmii to init in hsgmii lan driver

#define USB_LAN_VALID 		((get_serdes_ether_type_sel(ECNT_EVENT_SERDES_SEL_USB1) == ECNT_EVENT_SERDES_ETHER_TYPE_LAN) ? 1 : 0)
#define PCIE0_LAN_VALID		((get_serdes_ether_type_sel(ECNT_EVENT_SERDES_SEL_WIFI1) == ECNT_EVENT_SERDES_ETHER_TYPE_LAN) ? 1 : 0)
#define PCIE1_LAN_VALID		((get_serdes_ether_type_sel(ECNT_EVENT_SERDES_SEL_WIFI2) == ECNT_EVENT_SERDES_ETHER_TYPE_LAN) ? 1 : 0)			
#define ETH_LAN_VALID 		((get_serdes_ether_type_sel(ECNT_EVENT_SERDES_SEL_ETHER) == ECNT_EVENT_SERDES_ETHER_TYPE_LAN) ? 1 : 0)


#define PON_VALID PON_XSGMII_VALID

#define USB_VALID		(USB_XSGMII_VALID && USB_LAN_VALID)
#define PCIE0_VALID 	(PCIE0_XSGMII_VALID && PCIE0_LAN_VALID)
#define PCIE1_VALID		(PCIE1_XSGMII_VALID && PCIE1_LAN_VALID)
#define ETH_VALID		(ETH_XSGMII_VALID && ETH_LAN_VALID)
...
//============================================================================
#define RC_RD_DATA_L (0xB0)

//============================================================================
#define RC_RD_DATA_H (0xB4)

//============================================================================
#define RC_WR_DATA_L (0xB8)

//============================================================================
#define RC_WR_DATA_H (0xBC)

//============================================================================
#define TOTAL_RX_RC_CFG (0xA4)
...
//============================================================================
#define TOTAL_RC_RD_DATA_L RC_RD_DATA_L

//============================================================================
#define TOTAL_RC_RD_DATA_H RC_RD_DATA_H

//============================================================================
#define TOTAL_RC_WR_DATA_L RC_WR_DATA_L

//============================================================================
#define TOTAL_RC_WR_DATA_H RC_WR_DATA_H

//============================================================================
#define TOTAL_TX_RC_CFG (0xA0)
#define TOTAL_TX_RC_CFG_F_TOTAL_TX_RC_EN (1<<31)
#define TOTAL_TX_RC_CFG_F_TOTAL_TX_RATELIMIT_L2_EN (1<<30)
#define TOTAL_TX_RC_CFG_F_TOTAL_TX_SLOW_TICK_RATIO_SHIFT (16)
#define TOTAL_TX_RC_CFG_F_TOTAL_TX_SLOW_TICK_RATIO_MASK (0x3FFF0000)
#define TOTAL_TX_RC_CFG_F_TOTAL_TX_FAST_TICK_SHIFT (0)
#define TOTAL_TX_RC_CFG_F_TOTAL_TX_FAST_TICK_MASK (0xFFFF)

//============================================================================
#define TOTAL_TX_CFG RX_CFG
#define TOTAL_TX_CFG_F_TOTAL_RC_CFG_EN (1<<31)
#define TOTAL_TX_CFG_F_TOTAL_RC_CFG_PARAM_SHIFT (28)
#define TOTAL_TX_CFG_F_TOTAL_RC_CFG_PARAM_MASK (0x30000000)
#define TOTAL_TX_CFG_F_TOTAL_RC_CFG_ID (1<<16)
#define TOTAL_TX_CFG_F_TOTAL_RX_CFG_WR (1<<0)
...
#define XFI_MAC_PCIE1_RST (1<<16)
#define XFI_MAC_USB_RST   (1<<17)
