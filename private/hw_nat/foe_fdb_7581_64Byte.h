...
ECONET SOFTWARE.
***************************************************************/
#ifndef _FOE_FDB_7581_H
#define _FOE_FDB_7581_H
...
#define FOE_NUM_DEFAULT FOE_NUM_SIZE_48
...
int FoeGetEntries(struct hwnat_entries_args *opt);
