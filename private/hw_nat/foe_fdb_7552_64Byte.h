...
ECONET SOFTWARE.
***************************************************************/
#ifndef _FOE_FDB_7552_H
#define _FOE_FDB_7552_H
...
#define PPE_FOE_SIZE_64 80 //7581/7552 64byte extend to 80byte.
...
#define SRAM_MAX_ENTRY_NUM  (0x200)

#define DRAM_HASH_IDX_BASE SRAM_MAX_ENTRY_NUM
...
#define FOE_NUM_SIZE_64 64
#define FOE_NUM_SIZE_512 7

#define FOE_NUM_DEFAULT FOE_NUM_SIZE_16
#define SRAM_FOE_NUM_DEFAULT FOE_NUM_SIZE_512
...
struct _l2_bridge32 { /* 80 bytes */
	...
	uint32_t resv3:19;
	uint32_t dscp_en:1;	/* dscp enable */
#else
	uint32_t dscp_en:1; /* dscp enable */
	uint32_t resv3:19;
	uint32_t hop3:3;	/* hop id 3 */
...
{
    if(type == L2_BRIDGE)
        foe_entry->l2_bridge32.dscp_en = value&0x1;
