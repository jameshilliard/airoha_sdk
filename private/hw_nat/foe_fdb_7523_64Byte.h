...
ECONET SOFTWARE.
***************************************************************/
#ifndef _FOE_FDB_7523_H
#define _FOE_FDB_7523_H
...
{
	if(type == IPV4_HNAPT)
		foe_entry->ipv4_hnapt.dpi = (value&1);
	else if(type == IPV6_5T_ROUTE)
		foe_entry->ipv6_5t_route.dpi = (value&1);
	else if(type == L2_BRIDGE)
		foe_entry->l2_bridge32.dpi = (value&1);
	else if(type == IPV4_DSLITE)
		foe_entry->ipv4_dslite.dpi = (value&1);
