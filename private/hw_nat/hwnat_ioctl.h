...
#define HW_NAT_GET_ENTRIES          (0x49)
...
#define FOE_ARGS_MAX_ENTRIES_NUM (2 * 1024)
...
#ifdef CONFIG_TP_IMAGE
    LOCAL_IN_METHOD_BACKUP,
    LOCAL_IN_METHOD_RESTORE,
    LOCAL_IN_METHOD_BACKUP_SHOW,
#endif /* CONFIG_TP_IMAGE */
};
...
struct hwnat_tuple_ext {
	struct hwnat_tuple entry;
...
struct hwnat_entries_args {
	...
	unsigned int hwnat_enable_status;  /*0=off, 1=on*/
	unsigned int entry_skip;
	struct hwnat_tuple_ext all_entries[0];
};
