...
//	}
	...
	if (i == vcHuntSetNumber){ //COV, CID 139777
		printk("Can not find VC in VCPool!\n");
		return;
	} 
...
#if/*TCSUPPORT_COMPILE*/ defined(TCSUPPORT_AUTO_PVC_TRIGGER)
			i = 0;
...
#if/*TCSUPPORT_COMPILE*/ defined(TCSUPPORT_AUTO_PVC_TRIGGER)
		vcHuntSetNumber=1;//only do PVC0;
#else/*TCSUPPORT_COMPILE*/
		vcHuntSetNumber=MAX_PVC_NUM;
#endif/*TCSUPPORT_COMPILE*/
