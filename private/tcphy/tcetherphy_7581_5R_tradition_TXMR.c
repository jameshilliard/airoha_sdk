    ...
    {	//globle data
     	{
			...
			{0x1f, 0x0272, 0x0c2b},					// ps_op 0x3cff, for PHYD bug, need to workaround 
			{0x1f, 0x026a, 0x1113},
			{0x1f, 0x026f, 0x0000},

			{0x1f, 0x0268, 0x07f4},					
			{0x1f, 0x0269, 0x2114},					// ps_dri  //0x4344
			{0x1f, 0x0271, 0x2c63},					// 0x4e13, for PHYD bug, need to workaround
...
static int doPhyfactory_power (int argc, char *argv[], void *p);
...
static const cmds_t ethertphyprint[] =
{
	...
	{"factory_power",   doPhyfactory_power,  	0x02, 1, "factory_power <phyaddr> <on|off>"},
...
{ 
	...
	// =============================================================================================
      P9_tx_amp_tst_cha_comp=11;P10_tx_amp_tst_cha_comp=11;P11_tx_amp_tst_cha_comp=11;P12_tx_amp_tst_cha_comp=8;
      P9_tx_amp_tst_chb_comp=11;P10_tx_amp_tst_chb_comp=9;P11_tx_amp_tst_chb_comp=11;P12_tx_amp_tst_chb_comp=12;
      P9_tx_amp_tst_chc_comp=18;P10_tx_amp_tst_chc_comp=16;P11_tx_amp_tst_chc_comp=16;P12_tx_amp_tst_chc_comp=16;
      P9_tx_amp_tst_chd_comp=17;P10_tx_amp_tst_chd_comp=17;P11_tx_amp_tst_chd_comp=18;P12_tx_amp_tst_chd_comp=14;
	// =============================================================================================
	// Giga TX amp setting
	// =============================================================================================
      P9_tx_amp_gbe_cha_comp=11;P10_tx_amp_gbe_cha_comp=11;P11_tx_amp_gbe_cha_comp=11;P12_tx_amp_gbe_cha_comp=8;
      P9_tx_amp_gbe_chb_comp=11;P10_tx_amp_gbe_chb_comp=9;P11_tx_amp_gbe_chb_comp=11;P12_tx_amp_gbe_chb_comp=12;
      P9_tx_amp_gbe_chc_comp=18;P10_tx_amp_gbe_chc_comp=16;P11_tx_amp_gbe_chc_comp=16;P12_tx_amp_gbe_chc_comp=16;
      P9_tx_amp_gbe_chd_comp=17;P10_tx_amp_gbe_chd_comp=17;P11_tx_amp_gbe_chd_comp=18;P12_tx_amp_gbe_chd_comp=14;
	// =============================================================================================
	// 100M TX amp setting
	// =============================================================================================
      P9_tx_amp_hbt_cha_comp=28;P10_tx_amp_hbt_cha_comp=30;P11_tx_amp_hbt_cha_comp=28;P12_tx_amp_hbt_cha_comp=27;
      P9_tx_amp_hbt_chb_comp=26;P10_tx_amp_hbt_chb_comp=27;P11_tx_amp_hbt_chb_comp=27;P12_tx_amp_hbt_chb_comp=26;
	// =============================================================================================
	// 10M TX amp setting
	// =============================================================================================
	...
	// test mode TX amp setting
	// =============================================================================================
      P9_tx_amp_tst_cha_comp=10;P10_tx_amp_tst_cha_comp=6;P11_tx_amp_tst_cha_comp=9;P12_tx_amp_tst_cha_comp=11;
      P9_tx_amp_tst_chb_comp=8;P10_tx_amp_tst_chb_comp=7;P11_tx_amp_tst_chb_comp=8;P12_tx_amp_tst_chb_comp=8;
      P9_tx_amp_tst_chc_comp=12;P10_tx_amp_tst_chc_comp=9;P11_tx_amp_tst_chc_comp=8;P12_tx_amp_tst_chc_comp=13;
      P9_tx_amp_tst_chd_comp=11;P10_tx_amp_tst_chd_comp=12;P11_tx_amp_tst_chd_comp=12;P12_tx_amp_tst_chd_comp=14;
	// =============================================================================================
	// Giga TX amp setting
	// =============================================================================================
      P9_tx_amp_gbe_cha_comp=10;P10_tx_amp_gbe_cha_comp=6;P11_tx_amp_gbe_cha_comp=9;P12_tx_amp_gbe_cha_comp=11;
      P9_tx_amp_gbe_chb_comp=8;P10_tx_amp_gbe_chb_comp=7;P11_tx_amp_gbe_chb_comp=8;P12_tx_amp_gbe_chb_comp=8;
      P9_tx_amp_gbe_chc_comp=12;P10_tx_amp_gbe_chc_comp=9;P11_tx_amp_gbe_chc_comp=8;P12_tx_amp_gbe_chc_comp=13;
      P9_tx_amp_gbe_chd_comp=11;P10_tx_amp_gbe_chd_comp=12;P11_tx_amp_gbe_chd_comp=12;P12_tx_amp_gbe_chd_comp=14;
	// =============================================================================================
	// 100M TX amp setting
	// =============================================================================================
      P9_tx_amp_hbt_cha_comp=28;P10_tx_amp_hbt_cha_comp=26;P11_tx_amp_hbt_cha_comp=28;P12_tx_amp_hbt_cha_comp=28;
      P9_tx_amp_hbt_chb_comp=26;P10_tx_amp_hbt_chb_comp=26;P11_tx_amp_hbt_chb_comp=28;P12_tx_amp_hbt_chb_comp=29;
	// =============================================================================================
	// 10M TX amp setting
	// =============================================================================================
      P9_tx_amp_tbt_cha_comp=0;P10_tx_amp_tbt_cha_comp=0;P11_tx_amp_tbt_cha_comp=0;P12_tx_amp_tbt_cha_comp=0;
	...
	int count, int *eof, void *data)
{
	...
	val = tcMiiStationRead_CL45(0, 0x1F, 0xa434);
	...
	if (!REG_VAL_BIT_CHK(val, PHY_REG_VAL_SPEED_MSB_2_BIT))
	{
		if (REG_VAL_BIT_CHK(val, PHY_REG_VAL_SPEED_MSB_1_BIT))
		{
			if (REG_VAL_BIT_CHK(val, PHY_REG_VAL_SPEED_LSB_1_BIT) &&
		    	   !REG_VAL_BIT_CHK(val, PHY_REG_VAL_SPEED_LSB_2_BIT))
	    		{
	    			speed = "2500M";
	    		}
	    		else if (!REG_VAL_BIT_CHK(val, PHY_REG_VAL_SPEED_LSB_1_BIT) &&
		         	 REG_VAL_BIT_CHK(val, PHY_REG_VAL_SPEED_LSB_2_BIT))
			{
				speed = "5000M";
			}
...
static int doPhySwVer(int argc, char *argv[], void *p)
{
	...
	printf(": A7581.04.09_5R_setting_TXMR \r\n");  
	return 0;
} 
...
{	
	...
	{            
		...
		if(mode==1) 
			{ 		    
				if(control==1) {page1_reg1d=page1_reg1d|0x8000;} 		    
				if(control==0) {page1_reg1d=page1_reg1d&0x7fff;}		        
				tcMiiStationWrite(loop, 0x1a, page1_reg1d);
		        printf("port %d MDI Loopback \r\n",loop);					
			}
		
		tcMiiStationWrite(loop, 0x1f, 0x0000);		    
		if(mode==0)		
			{ 		
				if(control==1) {reg_00=reg_00|0x4000;}		
				if(control==0) {reg_00=reg_00&0xbfff;}        
...
int doPhyfactory_power(int argc, char *argv[], void *p) 	
{
	uint16 phyaddr = 0;
	
	phyaddr = checked_atoi(argv[1]);

	if(argc == 3) // tce factory_power <phyaddr> <on|off> 
	{
		if(stricmp(argv[2], "on") == 0)
		{
	...
	if(phyaddr == 0xFFFF)
	{
		printf("usage: tce factory_power <phyaddr> <on|off>  \r\n");
	}	
	return 0;
}
...
void doGePhyALLAnalogCal_R45(uint8 phyaddr) 
{
	...
	uint16	tx_amp_ofs_hbt, tx_amp_offset_hbt_p2, tx_amp_offset_hbt_p3, tx_amp_offset_hbt_p4, tx_amp_offset_tbt, tx_amp_offset_tbt_p4, tx_amp_temp_hbt, tx_amp_temp_tst, tx_amp_temp_tbt;
	...
	uint16	r50_ofs = 0, tx_amp_ofs_tst = 0, tx_amp_ofs_tst_a = 0;
	...
	mtEMiiRegWrite(phyaddr, 0x1e, 0x0145, 0x1010);			// fix mdi
	mtEMiiRegWrite(phyaddr, 0x1e, 0x0185, 0x0000);			// disable tx slew control
	mtEMiiRegWrite(phyaddr, 0x1e, 0x00fb, 0x0100);
	...
	for(calibration_pair = ANACAL_PAIR_A; calibration_pair <= ANACAL_PAIR_D; calibration_pair ++)
	{
		...
		else
		{
			...
			mtEMiiRegWrite(phyaddr, 0x1e, tx_amp_reg_100, (reg_temp|(tx_amp_temp)));	// for tst	// 1e_16, 1e_18, 1e_19, 1e_22[5:0]
			...
			mtEMiiRegWrite(phyaddr, 0x1e, tx_amp_reg_100, (reg_temp|(tx_amp_temp<<tx_amp_reg_shift)));	// for 100	// 1e_16, 1e_18, 1e_19, 1e_22[13:8]

			reg_temp = mtEMiiRegRead(phyaddr, 0x1e, tx_amp_reg)& (~0x003f);		// for tbt
			mtEMiiRegWrite(phyaddr, 0x1e, tx_amp_reg, (reg_temp|(tx_amp_temp)));	// for tbt	// 1e_12, 1e_17, 1e_18, 1e_21[5:0]
			...
			//tx_amp_ofs_tst_a = 8, tx_amp_ofs_tst_b = 9, tx_amp_ofs_tst_c = 9, tx_amp_ofs_tst_d = 9;
			tx_amp_ofs_tst_a = 0, tx_amp_ofs_tst_b = 0, tx_amp_ofs_tst_c = 0, tx_amp_ofs_tst_d = 0;
