...
extern void ledTurnOn(int value);
extern void ledTurnOff(int value);
#endif
/************************************************************************
...
#if/*TCSUPPORT_COMPILE*/ defined(TCSUPPORT_CHT_IGMP_NOLEAVEFLOOD)
...
#ifdef TCPHY_SUPPORT
#if/*TCSUPPORT_COMPILE*/ defined(TCSUPPORT_AGEOUT_MAC)
