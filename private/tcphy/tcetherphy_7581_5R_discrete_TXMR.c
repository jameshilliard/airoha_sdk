...
static uint8    sw_down_shift_en=1;
...
{
    uint8 	pn;
	uint32 	reg0, reg1, reg9, reg10,reg_temp,reg_9_temp,reg_10_temp,reg_temp1,master_times=2,slave_times=4;
	uint32 	dev_1e_reg_a2,dev_1e_reg_a2_temp;
    ...
    for(phyaddr = gphy_base; phyaddr < (gphy_base+EN75xxGe_PORTNUM); phyaddr++) 
	{
        ...
        else if( !Nmr1[pn].link_status_prev && Nmr1[pn].link_status )
		{
			...
			if(link_state_polling == 1){printf("phy=%d link down to up\n\r",phyaddr);printf("\n\r");}
        }
        else if( Nmr1[pn].link_status_prev && !Nmr1[pn].link_status )
		{
			...
			if(link_state_polling == 1){printf("phy=%d link up to down\n\r",phyaddr);printf("\n\r");}
        }
        else 
		{ 	//if( Nmr1[pn].link_status_prev && Nmr1[pn].link_status ){
		...
		if((reg_temp != 0)&&(reg_temp1 == 0)) 								// check 1000Mbps capbility
		{
			...
			if((reg_temp1!=0)&&(reg_temp!=0))	// local phy is slave && collision
			{
				reg_temp=(reg_9_temp&0xe7ff)|0x1800;
			    tcMiiStationWrite(phyaddr, 0x09, reg_temp); 	// set giga force master
				force_giga_master_counter_p9=force_giga_master_counter_p9+1;
			}
			if((reg_temp1!=0)&&(reg_temp!=0)&&(force_giga_master_counter_p9>master_times))	// local phy is slave && collision
			{
			...
			if((reg_temp1!=0)&&(reg_temp==0)&&(force_giga_master_counter_p9>slave_times))	// local phy is slave && collision
			{
				reg_temp=(reg_9_temp&0xe7ff)|0x1800;
			    tcMiiStationWrite(phyaddr, 0x09, reg_temp); 	// set giga force slave
				force_giga_master_counter_p9=0;
			...
			if((reg_temp1!=0)&&(reg_temp!=0)&&(force_giga_master_counter_p10>master_times))	// local phy is slave && collision
			{
				reg_temp=(reg_9_temp&0xe7ff)|0x0600;
			    tcMiiStationWrite(phyaddr, 0x09, reg_temp); 	// set giga force slave
			...
			if((reg_temp1!=0)&&(reg_temp==0)&&(force_giga_master_counter_p10>slave_times))	// local phy is slave && collision
			{
				reg_temp=(reg_9_temp&0xe7ff)|0x1800;
			    tcMiiStationWrite(phyaddr, 0x09, reg_temp); 	// set giga force slave
				force_giga_master_counter_p10=0;
			...
			if((reg_temp1!=0)&&(reg_temp!=0)&&(force_giga_master_counter_p11>master_times))	// local phy is slave && collision
			{
				reg_temp=(reg_9_temp&0xe7ff)|0x0600;
			    tcMiiStationWrite(phyaddr, 0x09, reg_temp); 	// set giga force slave
			...
			if((reg_temp1!=0)&&(reg_temp==0)&&(force_giga_master_counter_p11>slave_times))	// local phy is slave && collision
			{
				reg_temp=(reg_9_temp&0xe7ff)|0x1800;
			    tcMiiStationWrite(phyaddr, 0x09, reg_temp); 	// set giga force slave
				force_giga_master_counter_p11=0;
			...
			if((reg_temp1!=0)&&(reg_temp!=0)&&(force_giga_master_counter_p12>master_times))	// local phy is slave && collision
			{
				reg_temp=(reg_9_temp&0xe7ff)|0x0600;
			    tcMiiStationWrite(phyaddr, 0x09, reg_temp); 	// set giga force slave
			...
			if((reg_temp1!=0)&&(reg_temp==0)&&(force_giga_master_counter_p12>slave_times))	// local phy is slave && collision
			{
				reg_temp=(reg_9_temp&0xe7ff)|0x1800;
			    tcMiiStationWrite(phyaddr, 0x09, reg_temp); 	// set giga force slave
				force_giga_master_counter_p12=0;
...
//static int doPhyMiiReadTest(int argc, char *argv[], void *p);
...
{ 
	...
	// =============================================================================================
      P9_tx_amp_tst_cha_comp=8;P10_tx_amp_tst_cha_comp=8;P11_tx_amp_tst_cha_comp=8;P12_tx_amp_tst_cha_comp=8;
      P9_tx_amp_tst_chb_comp=8;P10_tx_amp_tst_chb_comp=7;P11_tx_amp_tst_chb_comp=7;P12_tx_amp_tst_chb_comp=6;
      P9_tx_amp_tst_chc_comp=9;P10_tx_amp_tst_chc_comp=8;P11_tx_amp_tst_chc_comp=8;P12_tx_amp_tst_chc_comp=8;
      P9_tx_amp_tst_chd_comp=8;P10_tx_amp_tst_chd_comp=8;P11_tx_amp_tst_chd_comp=8;P12_tx_amp_tst_chd_comp=8;
	// =============================================================================================
	// Giga TX amp setting
	// =============================================================================================
      P9_tx_amp_gbe_cha_comp=-7;P10_tx_amp_gbe_cha_comp=-7;P11_tx_amp_gbe_cha_comp=-7;P12_tx_amp_gbe_cha_comp=-7;
      P9_tx_amp_gbe_chb_comp=-7;P10_tx_amp_gbe_chb_comp=-8;P11_tx_amp_gbe_chb_comp=-8;P12_tx_amp_gbe_chb_comp=-9;
      P9_tx_amp_gbe_chc_comp=-6;P10_tx_amp_gbe_chc_comp=-7;P11_tx_amp_gbe_chc_comp=-7;P12_tx_amp_gbe_chc_comp=-7;
      P9_tx_amp_gbe_chd_comp=-7;P10_tx_amp_gbe_chd_comp=-7;P11_tx_amp_gbe_chd_comp=-7;P12_tx_amp_gbe_chd_comp=-7;
	// =============================================================================================
	// 100M TX amp setting
	// =============================================================================================
      P9_tx_amp_hbt_cha_comp=17;P10_tx_amp_hbt_cha_comp=13;P11_tx_amp_hbt_cha_comp=16;P12_tx_amp_hbt_cha_comp=17;
      P9_tx_amp_hbt_chb_comp=17;P10_tx_amp_hbt_chb_comp=13;P11_tx_amp_hbt_chb_comp=16;P12_tx_amp_hbt_chb_comp=17;
	// =============================================================================================
	// 10M TX amp setting
	// =============================================================================================
      P9_tx_amp_tbt_cha_comp=22;P10_tx_amp_tbt_cha_comp=22;P11_tx_amp_tbt_cha_comp=22;P12_tx_amp_tbt_cha_comp=23;
      P9_tx_amp_tbt_chb_comp=22;P10_tx_amp_tbt_chb_comp=22;P11_tx_amp_tbt_chb_comp=22;P12_tx_amp_tbt_chb_comp=23;
...
void my_ephy_monitor(unsigned long data)
{
    ...
    /* add your code here */
	tcMiiStationWrite(9, 0x04, 0x0de1);
	tcMiiStationWrite(10, 0x04, 0x0de1);
	tcMiiStationWrite(11, 0x04, 0x0de1);
	tcMiiStationWrite(12, 0x04, 0x0de1);
}
	...
	for(ephy_addr = 9; ephy_addr <= 12; ephy_addr++)
		{
				    ...
				    tcMiiStationWrite(ephy_addr, 0x14, 0x3a14);
...
static int doPhySwVer(int argc, char *argv[], void *p)
{
	...
	printf(": A7581.04.055_5R setting_discrete_TXMR \r\n");  
	return 0;
} 
...
void doEphySetSLTMode(uint8 phyaddr, uint16 speed_mode)
{
	...
	uint32 slt_counter= 0,slt_counter_out = 10000;
    sw_down_shift_en=0;
	tcMiiStationWrite(phyaddr, 0x1f, 0x0001);
	tcMiiStationWrite(phyaddr, 0x14, 0x3A04);
    mtEMiiRegWrite(phyaddr, 0x7, 0x0145, 0x1010);	
    ...
    if(speed_mode == 10)
	{
        ...
        tcMiiStationWrite(phyaddr, 0x1f, 0x0000);
		tcMiiStationWrite(phyaddr, 0x09, 0x0000);
		tcMiiStationWrite(phyaddr, 0x00, 0x0100);
		printf(" phy %d 10M\r\n",phyaddr);
	}
	...
	else if(speed_mode == 1000)
	{
	    ...
	    if(phyaddr==12)   
		{			
	    value_9 = tcMiiStationRead(9, 1);
	    value_10 = tcMiiStationRead(10, 1);
	    value_11 = tcMiiStationRead(11, 1);
	    value_12 = tcMiiStationRead(12, 1);
		for(value = 0; value<=60000; value++)
		{
		    value_9 = tcMiiStationRead(9, 1);
			value_9= value_9&0x0004;
			if(value_9 != 0) {link_9=1;} else {link_9=0;slt_counter=0;}
			value_10 = tcMiiStationRead(10, 1);
			value_10= value_10&0x0004;
			if(value_10!= 0) {link_10=1;} else {link_10=0;slt_counter=0;}
			value_11 = tcMiiStationRead(11, 1);
			value_11= value_11&0x0004;
			if(value_11!= 0) {link_11=1;} else {link_11=0;slt_counter=0;}
			value_12 = tcMiiStationRead(12, 1);
			value_12= value_12&0x0004;
			if(value_12!= 0) {link_12=1;} else {link_12=0;slt_counter=0;}
			if((link_9== 1)&&(link_10== 1)&&(link_11== 1)&&(link_12== 1))
			{

				//printf(" all port link OK \r\n");
				slt_counter++;
			}
			if(slt_counter>= slt_counter_out) 
			{
		    value=60001;			
				
			}
			if(value>= 60000) {
			if(value_9== 0) { printf(" port9 unlink \r\n");}
			if(value_10== 0) { printf(" port10 unlink \r\n");}
			if(value_11== 0) { printf(" port11 unlink \r\n");}
			if(value_12== 0) { printf(" port12 unlink \r\n");}			
			//printf(" port%d unlink \r\n", phyaddr);}
