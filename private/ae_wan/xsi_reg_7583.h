...
#define XSI_IDX_MAX		XSI_ETH_IDX
...
extern unsigned int HSGMII_BASE_REG[5];
...
#define PON_VALID 		(PON_XSGMII_VALID && PON_WAN_VALID || PON_LAN_VALID)
#define USB_VALID		(USB_XSGMII_VALID && USB_WAN_VALID)
#define PCIE0_VALID 	(PCIE0_XSGMII_VALID && PCIE0_WAN_VALID)
#define PCIE1_VALID		(PCIE1_XSGMII_VALID && PCIE1_WAN_VALID)
#define ETH_VALID		(ETH_XSGMII_VALID && ETH_WAN_VALID)
...
static inline void sgmii_api_force_mode(unsigned int port, unsigned int speed)
{
	return;
}
