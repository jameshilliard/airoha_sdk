...
#define RAETH_LINK_AGGREGATION  0x89FD

#define RAETH_GSWEXT2_REG_READ       0x89FE
#define RAETH_GSWEXT2_REG_WRITE      0x89FF
...
struct sk_buff * macEN7512STagInsert(ethTxMsg_t *TxMsg, struct sk_buff *bp);
int macEN7512STagRemove(QDMA_RxMsg_Ether_T *rxmsg, struct sk_buff *bp);
