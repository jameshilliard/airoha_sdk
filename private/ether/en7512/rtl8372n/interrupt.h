...
typedef enum interrupt_misc_e
{
    MISC_INT_TM_HIGH=0,
    MISC_INT_TM_LOW,
    MISC_INT_SMI_CHECK_REG_0,
    MISC_INT_SMI_CHECK_REG_1,
    MISC_INT_SMI_CHECK_REG_2,
    MISC_INT_SMI_CHECK_REG_3,
    MISC_INT_SMI_CHECK_REG_4,
    MISC_INT_SDS_RX_SYM_ERR_0,
    MISC_INT_SDS_RX_SYM_ERR_1,
    MISC_INT_SAMOVE = 10,
    MISC_INT_AUTO_REC,
    MISC_INT_ACL = 13,
    MISC_INT_LOOP_DETEC = 15,
    MISC_INT_METER_EXCEED,
    MISC_INT_ROUT_PBUF,
    MISC_INT_PTP1588,
    MISC_INT_MACSEC_P0,
    MISC_INT_MACSEC_P1,
