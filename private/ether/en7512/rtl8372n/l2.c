 ...
 */
rtk_api_ret_t rtk_l2_limitLearningCntAction_set( rtk_l2_limitLearnCntAction_t action)
{
    rtk_api_ret_t retVal;
    ...
    RTK_API_LOCK();
    retVal = RT_MAPPER->l2_limitLearningCntAction_set( action);
    RTK_API_UNLOCK();
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
rtk_api_ret_t rtk_l2_limitLearningCntAction_get(rtk_l2_limitLearnCntAction_t *pAction)
{
    rtk_api_ret_t retVal;
    ...
    RTK_API_LOCK();
    retVal = RT_MAPPER->l2_limitLearningCntAction_get( pAction);
    RTK_API_UNLOCK();
