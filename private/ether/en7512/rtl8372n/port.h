...
typedef struct rtk_rtct_result_s
{
 ...
 */
extern rtk_api_ret_t rtk_port_rtct_init(rtk_port_t port);
...
extern rtk_api_ret_t rtk_port_extphyid_get(rtk_uint32 sdsid,  rtk_uint32 *phyid);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_port_txPacketMaxLength_set(rtk_port_t port, rtk_uint32 type, rtk_uint32 pktLen);
 ...
 *      None
 */
extern rtk_api_ret_t rtk_port_txPacketMaxLength_get(rtk_port_t port, rtk_uint32 type, rtk_uint32 *pPktLen);
#endif