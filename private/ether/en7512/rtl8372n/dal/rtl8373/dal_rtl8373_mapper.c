...
static dal_mapper_t dal_rtl8373_mapper =
{
    ...
    .dot1x_guestVlan2Auth_get = dal_rtl8373_dot1x_guestVlan2Auth_get,
     ...
     .macsec_port_cfg_set = dal_rtl8373_macsec_port_cfg_set,
 	.macsec_port_cfg_get = dal_rtl8373_macsec_port_cfg_get,
 	.macsec_sc_create = dal_rtl8373_macsec_sc_create,
 	.macsec_sc_get = dal_rtl8373_macsec_sc_get,
 	.macsec_sc_del = dal_rtl8373_macsec_sc_del,
 	.macsec_sc_status_get = dal_rtl8373_macsec_sc_status_get,
 	.macsec_sa_create = dal_rtl8373_macsec_sa_create,
 	.macsec_sa_get = dal_rtl8373_macsec_sa_get,
 	.macsec_sa_del = dal_rtl8373_macsec_sa_del,
 	.macsec_sa_activate = dal_rtl8373_macsec_sa_activate,
 	.macsec_rxsa_disable = dal_rtl8373_macsec_rxsa_disable,
 	.macsec_txsa_disable = dal_rtl8373_macsec_txsa_disable,
 	.macsec_stat_clear = dal_rtl8373_macsec_stat_clear,
 	.macsec_stat_port_get = dal_rtl8373_macsec_stat_port_get,
 	.macsec_stat_txsa_get = dal_rtl8373_macsec_stat_txsa_get,
 	.macsec_stat_rxsa_get = dal_rtl8373_macsec_stat_rxsa_get,
 	.macsec_intr_status_get = dal_rtl8373_macsec_intr_status_get,
#endif
   ...
   // .svlan_memberPortEntry_get = dal_rtl8373_svlanmemberPortEntry_get,
    ...
    .port_txPktMaxLen_set = dal_rtl8373_port_txPktMaxLen_set,
    .port_txPktMaxLen_get = dal_rtl8373_port_txPktMaxLen_get,
    ...
    .phy_autoNegoAbility_get = dal_rlt8373_phy_autoNegoAbility_get,
