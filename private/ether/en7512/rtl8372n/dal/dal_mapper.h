...
typedef struct dal_mapper_s {
   ...
   // rtk_api_ret_t (*dot1x_eapolFrame2CpuEnable_set)(rtk_enable_t);
	...
	rtk_api_ret_t(*macsec_port_cfg_set)(rtk_port_t, rtk_macsec_port_cfg_t *);
    rtk_api_ret_t(*macsec_port_cfg_get)(rtk_port_t, rtk_macsec_port_cfg_t *);
    rtk_api_ret_t(*macsec_sc_create)(rtk_port_t, rtk_macsec_dir_t, rtk_macsec_sc_t *, rtk_uint32 *);
    rtk_api_ret_t(*macsec_sc_get)(rtk_port_t, rtk_macsec_dir_t, rtk_uint32, rtk_macsec_sc_t  *);
    rtk_api_ret_t(*macsec_sc_del)(rtk_port_t, rtk_macsec_dir_t, rtk_uint32);
    rtk_api_ret_t(*macsec_sc_status_get)(rtk_port_t, rtk_macsec_dir_t, rtk_uint32, rtk_macsec_sc_status_t *);
    rtk_api_ret_t(*macsec_sa_create)(rtk_port_t, rtk_macsec_dir_t, rtk_uint32, rtk_macsec_an_t, rtk_macsec_sa_t *);
    rtk_api_ret_t(*macsec_sa_get)(rtk_port_t, rtk_macsec_dir_t, rtk_uint32, rtk_macsec_an_t, rtk_macsec_sa_t *);
    rtk_api_ret_t(*macsec_sa_del)(rtk_port_t, rtk_macsec_dir_t, rtk_uint32, rtk_macsec_an_t);
    rtk_api_ret_t(*macsec_sa_activate)(rtk_port_t, rtk_macsec_dir_t, rtk_uint32, rtk_macsec_an_t);
    rtk_api_ret_t(*macsec_rxsa_disable)(rtk_port_t, rtk_uint32, rtk_macsec_an_t);
    rtk_api_ret_t(*macsec_txsa_disable)(rtk_port_t, rtk_uint32);
    rtk_api_ret_t(*macsec_stat_clear)(rtk_port_t);
    rtk_api_ret_t(*macsec_stat_port_get)(rtk_port_t, rtk_macsec_stat_t, rtk_uint64 *);
    rtk_api_ret_t(*macsec_stat_txsa_get)(rtk_port_t, rtk_uint32, rtk_macsec_an_t, rtk_macsec_txsa_stat_t, rtk_uint64 *);
    rtk_api_ret_t(*macsec_stat_rxsa_get)(rtk_port_t, rtk_uint32, rtk_macsec_an_t, rtk_macsec_rxsa_stat_t, rtk_uint64 *);
    rtk_api_ret_t(*macsec_intr_status_get)(rtk_port_t, rtk_macsec_intr_status_t *);    
 ...
 /* Time */
   ...
   rtk_api_ret_t   (*time_portPtpVlanTpid_get)( rtk_vlanType_t , rtk_uint32 , rtk_uint32 *);
    ...
    rtk_api_ret_t (*l2_limitLearningCntAction_set)(rtk_l2_limitLearnCntAction_t);
    rtk_api_ret_t (*l2_limitLearningCntAction_get)(rtk_l2_limitLearnCntAction_t *);
    ...
    rtk_api_ret_t (*port_rtct_init)(rtk_port_t);
	...
	rtk_api_ret_t (*port_txPktMaxLen_set)(rtk_port_t, rtk_uint32, rtk_uint32);
    rtk_api_ret_t (*port_txPktMaxLen_get)(rtk_port_t, rtk_uint32, rtk_uint32 *);
    ...
    rtk_api_ret_t (*phy_autoNegoAbility_get)(rtk_port_t, rtk_port_phy_ability_t *);
