...
#define BITMAP_IS_SET(array, index)   (array[index/(sizeof(array[0]) << 3)] & (0x1 << (index%(sizeof(array[0]) << 3))))
#define BITMAP_IS_CLEAR(array, index)  !(array[index/(sizeof(array[0]) << 3)] & (0x1 << (index%(sizeof(array[0]) << 3))))
#define BITMAP_SET(array, index) do {   array[index/(sizeof(array[0]) << 3)] =    (array[index/(sizeof(array[0]) << 3)] | (0x1 << (index%(sizeof(array[0]) << 3)))); } while(0)
#define BITMAP_CLEAR(array, index) do {   array[index/(sizeof(array[0]) << 3)] =    (array[index/(sizeof(array[0]) << 3)] & ~(0x1 << (index%(sizeof(array[0]) << 3)))); } while(0)
#define BITMAP_ARRAY_CNT(number_of_indexs) ((number_of_indexs + (BITMAP_WIDTH - 1))/BITMAP_WIDTH)
...
typedef rtk_uint32                                  rtk_bitmap_t;
