...
void phy_trans_params_parser(void)
{
	...
	//if(PHY_TRANS_NOT_FOUND_IN_IOT_LIST!=gpPhyPriv->trans_index)
	{
		//Table 3.1 Two-wire interface ID: Data Fields 篓C Address A0h
		phy_reg_total_num=255;
		phy_reg_all=phy_trans_table_1;
		...
		//Table 3.1a Diagnostics: Data Fields 篓C Address A2h
		phy_reg_total_num=255;
		phy_reg_all=phy_trans_table_2;
		...
		//Table 3.13: Bit weights (隆茫C) for temperature reporting registers
